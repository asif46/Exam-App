...
import 'package:untitled/models/student_result_model.dart';
import 'package:untitled/models/user.dart';
import 'package:untitled/widgets/result_card.dart';
...
class _ResultScreenState extends State<ResultScreen> {
  ...
  Future<List<StudentResultModel>> checkResult() async {
    ...
    var response = await http.get(
      Uri.https(BASE_URL, 'TSpanel/public/api/studentResult', _queryParameters),
    );
