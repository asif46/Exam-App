...
import 'package:untitled/controllers/student_exam_paper_controller.dart';
import 'package:untitled/models/student_attempt_paper_model.dart';
import 'package:untitled/screens/student/exam_tabs.dart';
...
class _StartExamState extends State<StartExam> {
  ...
  Widget build(BuildContext context) {
    StudentAttempPaperModel examList;
    return Scaffold(
        appBar: AppBar(
  ...
  Future<StudentAttempPaperModel> getExamPaper() async {
    ...
    var response = await http.get(
      Uri.https(
          BASE_URL, 'TSpanel/public/api/getSinglePaper', _queryParameters),
    );
