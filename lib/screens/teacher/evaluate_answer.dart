...
import 'package:untitled/models/evaluatepaper_model.dart';
import 'package:untitled/screens/teacher/viewTheoryans.dart';
...
class _EvaluateAnswerState extends State<EvaluateAnswer> {
  ...
  Future<List<EvaluatePaperModel>> evaluteResult() async {
    ...
    var response = await http.get(Uri.https(
        BASE_URL, 'TSpanel/public/api/allSubmitPapers', _queryParameters));
    print(response.body);
